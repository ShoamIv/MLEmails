...
def initiate_preprocessdata(datastore_path, figure_folder):
    # Load dataset
...
def preprocess_data(datastore_path, figure_folder):
    initiate_preprocessdata(datastore_path, figure_folder)
